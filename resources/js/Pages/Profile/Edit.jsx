...
export default function Edit({ mustVerifyEmail, status }) {
    ...
    return (
        <div>
            <div className="min-h-screen font-tajawal bg-gradient-to-br from-blue-50 to-gray-100 pb-8">
                <div className="w-full mx-auto px-4">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        <div className="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden lg:col-span-2">
                            <div className="bg-gradient-to-l flex justify-between from-blue-500 to-blue-600 p-6">
                                ...
                                <button
                                    ...
                                    className="flex items-center gap-2 text-white hover:text-blue-600 transition-colors duration-200 p-3 hover:bg-blue-50 rounded-lg"
                                >
